...
//        Server().url("https://historical-prisoner-api-preprod.prison.service.justice.gov.uk").description("PreProd"),
//        Server().url("https://historical-prisoner-api.prison.service.justice.gov.uk").description("Prod"),
    ...
    .info(
      Info().title("Historical Prisoner Search").version(version)
